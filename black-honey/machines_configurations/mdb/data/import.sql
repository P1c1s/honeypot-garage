...
('Manager', 'Responsabile della gestione e supervisione generale'),
('Developer', 'Sviluppatore software'),
('Designer', 'Progettista grafico e UX/UI'),
('Contabile', 'Responsabile contabilità e bilanci'),
('Supporto', 'Supporto tecnico e assistenza clienti'),
('Direttore', 'Direttore generale aziendale'),
('Amministratore', 'Gestione amministrativa e burocratica');
...
('Giorgia', 'Botteri', '2023-02-10', 2, 1800.00),
('Fabio', 'Zarfagna', '2024-03-05', 3, 2000.00),
('Lorenzo', 'Ricci', '2023-01-20', 4, 2200.00),
('Elisabetta', 'Dinosauro', '2024-04-01', 5, 2700.00),
('Pietro', 'Guerra', '2024-02-25', 2, 2900.00),
('Sara', 'Conti', '2023-03-18', 3, 2100.00),
('Federica', 'Cera', '2023-01-30', 6, 2200.00),
('Chiara', 'Moretti', '2024-04-15', 7, 1800.00),
('Stefano', 'Fodera', '2024-05-01', 5, 2600.00),
('Matteo', 'Righi', '2023-05-01', 5, 1600.00),
('Milena', 'Poddia', '2024-05-01', 5, 1500.00);

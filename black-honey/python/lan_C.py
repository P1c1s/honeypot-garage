...
# LAN C
switchc = lab.new_machine("switchc", image="theb0ys/base")
...
wsa2 = lab.new_machine("wsa2", image="theb0ys/apache")
...
lab.get_machine("wsa2").copy_directory_from_path("machines_configurations/syslog-client", "/etc")
lab.create_startup_file_from_path(wsa2, "machines_startup_script/lan_c/wsa2.sh")

wsn = lab.new_machine("wsn", image="theb0ys/nginx")
...
ovpn = lab.new_machine("ovpn", image="kathara/base")
